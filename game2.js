...
class GameScene2 extends Scene {
    ...
    constructor() {
        ...
        this.speechContainer.addChild(this.inputContainer);    
         ...
         this.manual2 = new PIXI.Sprite.fromImage('imglv2/manual2.png', true, imageMode);
        this.manual2.anchor.set(0.5, 0.5);
        this.manual2.x = 1150;
        this.manual2.y = 630;
        this.manual2.scale.set(0.5);
        this.manual2.texture.baseTexture.mipmap = false;
        this.manual2.autoresize = true;
        this.addChild(this.manual2);
        ...
        this.popup1bg = new PIXI.Sprite.fromImage('imglv2/t1.png', true, imageMode);
        ...
        this.popup2bg = new PIXI.Sprite.fromImage('imglv2/t2.png', true, imageMode);
        ...
        this.popup3bg = new PIXI.Sprite.fromImage('imglv2/t3.png', true, imageMode);
        ...
        this.popup4bg = new PIXI.Sprite.fromImage('imglv2/t4.png', true, imageMode);
        ...
        this.popup5bg = new PIXI.Sprite.fromImage('imglv2/t5.png', true, imageMode);
        ...
        this.popup6bg = new PIXI.Sprite.fromImage('imglv2/t6.png', true, imageMode);
        ...
        this.popup7bg = new PIXI.Sprite.fromImage('imglv2/t7.png', true, imageMode);
    ...
    submitCode() {
        ...
        if(JSON.stringify(this.input) == JSON.stringify(this.selectedPerson.type)) {                // alert('cool');
