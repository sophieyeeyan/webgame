...
class GameScene3 extends Scene {
    ...
    constructor() {
        ...
        this.speechContainer.addChild(this.inputContainer);    
         ...
         this.manual3 = new PIXI.Sprite.fromImage('imglv3/manual3.png', true, imageMode);
        this.manual3.anchor.set(0.5, 0.5);
        this.manual3.x = 1150;
        this.manual3.y = 630;
        this.manual3.scale.set(0.5);
        this.manual3.texture.baseTexture.mipmap = false;
        this.manual3.autoresize = true;
        this.addChild(this.manual3);

        this.cyber = new PIXI.Sprite.from('imglv3/cyber3.png');
        this.cyber.anchor.set(0.5);
        this.cyber.x = this.width/2;
        this.cyber.y = 220;
        this.cyber.width = 530;
        this.cyber.height = 456;
        // this.autoresize = true;
        ...
        this.popup1bg = new PIXI.Sprite.fromImage('imglv3/t1.png', true, imageMode);
        ...
        this.popup2bg = new PIXI.Sprite.fromImage('imglv3/t2.png', true, imageMode);
        ...
        this.popup3bg = new PIXI.Sprite.fromImage('imglv3/t3.png', true, imageMode);
        ...
        this.popup4bg = new PIXI.Sprite.fromImage('imglv3/t4.png', true, imageMode);
        ...
        this.popup5bg = new PIXI.Sprite.fromImage('imglv3/t5.png', true, imageMode);
        ...
        this.popup6bg = new PIXI.Sprite.fromImage('imglv3/t6.png', true, imageMode);
        ...
        this.popup7bg = new PIXI.Sprite.fromImage('imglv3/t7.png', true, imageMode);
    ...
    spawn() {
        ...
        var coordinates = [
            ...
            [859,366]];
            var choice = ["i","j","k","l"];
        var c = coordinates[Math.floor(Math.random() * 15)];
