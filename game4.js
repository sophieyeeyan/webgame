...
class GameScene4 extends Scene {
    ...
    constructor() {
        ...
        this.manual5 = new PIXI.Sprite.fromImage('imglvfive/manual5.png', true, imageMode);
        this.manual5.anchor.set(0.5, 0.5);
        this.manual5.x = 1150;
        this.manual5.y = 630;
        this.manual5.scale.set(0.5);
        this.manual5.texture.baseTexture.mipmap = false;
        this.manual5.autoresize = true;
        this.addChild(this.manual5);

        this.cyber = new PIXI.Sprite.from('imglvfive/cyber5.png');
        this.cyber.anchor.set(0.5);
        this.cyber.x = this.width/2;
        this.cyber.y = 200;
        this.cyber.width = 560;
        ...
        this.popup1bg = new PIXI.Sprite.fromImage('imglvfive/t1.png', true, imageMode);
        ...
        this.popup2bg = new PIXI.Sprite.fromImage('imglvfive/t2.png', true, imageMode);
        ...
        this.popup3bg = new PIXI.Sprite.fromImage('imglvfive/t3.png', true, imageMode);
        ...
        this.popup4bg = new PIXI.Sprite.fromImage('imglvfive/t4.png', true, imageMode);
        ...
        this.popup5bg = new PIXI.Sprite.fromImage('imglvfive/t5.png', true, imageMode);
        ...
        this.popup6bg = new PIXI.Sprite.fromImage('imglvfive/t6.png', true, imageMode);
        ...
        this.popup7bg = new PIXI.Sprite.fromImage('imglvfive/t7.png', true, imageMode);
        ...
        this.startgameButton.x = (this.popup7Container.width/2);
        this.startgameButton.y = (this.popup7Container.height/2) + 75;
        ...
        this.popup7Container.addChild(this.startgameButton);
    ...
    onButtonOut() {
     ...
     onPlayVideo1() {
        const $this = this;
        const covertexture = PIXI.Texture.from('vid/storylv2.mp4');
    ...
    spawn() {
        ...
        var coordinates = [
            ...
            [859,366]];
            var choice = ["m","n","o","p"];
        var c = coordinates[Math.floor(Math.random() * 14)];
        var myc =  choice[Math.floor(Math.random() * choice.length)];
        console.log(myc);
