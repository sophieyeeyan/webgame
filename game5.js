...
class GameScene5 extends Scene {
    ...
    constructor() {
        ...
        this.manual6 = new PIXI.Sprite.fromImage('imglv6/manual6.png', true, imageMode);
        this.manual6.anchor.set(0.5, 0.5);
        this.manual6.x = 1150;
        this.manual6.y = 630;
        this.manual6.scale.set(0.5);
        this.manual6.texture.baseTexture.mipmap = false;
        this.manual6.autoresize = true;
        this.addChild(this.manual6);

        this.cyber = new PIXI.Sprite.from('imglv6/cyber.png');
        ...
        this.popup1bg = new PIXI.Sprite.fromImage('imglv6/t1.png', true, imageMode);
        ...
        this.popup2bg = new PIXI.Sprite.fromImage('imglv6/t2.png', true, imageMode);
        ...
        this.popup3bg = new PIXI.Sprite.fromImage('imglv6/t3.png', true, imageMode);
        ...
        this.popup4bg = new PIXI.Sprite.fromImage('imglv6/t4.png', true, imageMode);
        ...
        this.popup5bg = new PIXI.Sprite.fromImage('imglv6/t5.png', true, imageMode);
        ...
        this.popup6bg = new PIXI.Sprite.fromImage('imglv6/t6.png', true, imageMode);
        ...
        this.popup7bg = new PIXI.Sprite.fromImage('imglv6/t7.png', true, imageMode);
    ...
    spawn() {
        ...
        var coordinates = [
            ...
            [859,366]];
            var choice = ["q","r","s","t"];
        var c = coordinates[Math.floor(Math.random() * 12)];
